...
public class Messages {
    ...
    public static String PartyInviteInviteeInParty = "PLAYER is already in a golf party.";
    public static String PartyInviteInvited = "You have been invited to a golf party by PLAYER.";
    ...
    public static String PartyInviteTimeoutToParty = "PLAYER's invite has timed out.";
    ...
    public static String PartyRejectTOParty = "PLAYER has rejected the golf party invite.";
    ...
    public static String CosmeticInvalidModelID = "The Model ID is not numeric";
    ...
    // Action Bar Messages
    public static String StartGolfActionBar = "Joining COURSE in TIME seconds with a party of AMOUNT";
    public static String NextHoleInfo = "HOLE : Par AMOUNT";
